...
//  EcheTest
//
//  Eche BLE Test Application for iOS/macOS
//

import SwiftUI

@main
struct EcheTestApp: App {
    @StateObject private var viewModel = EcheViewModel()
    ...
    var body: some Scene {
        ...
        .commands {
            ...
            CommandGroup(replacing: .appInfo) {
                Button("About Eche Test") {
                    NSApplication.shared.orderFrontStandardAboutPanel(
                        options: [
                            NSApplication.AboutPanelOptionKey.applicationName: "Eche Test",
