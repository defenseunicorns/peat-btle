...
//  EcheTest
//
//  Model representing a peer in the ECHE mesh network
//

import Foundation

/// Represents a peer in the ECHE mesh network
struct EchePeer: Identifiable, Equatable, Hashable {
    ...
    var displayName: String {
        if let meshId = meshId {
            ...
            return String(format: "ECHE-%08X", nodeId)
        }
    }
...
/// Event types that can be sent/received in the ECHE mesh
enum EcheEventType: String, CaseIterable {
    case none = "None"
