...
fn create_unencrypted_mesh(node_id: u32, callsign: &str) -> HiveMesh {
...
fn populate_mesh_with_chats(mesh: &HiveMesh, count: usize) {
    for i in 0..count {
...
fn benchmark_build_document(mesh: &HiveMesh, iterations: usize) -> Duration {
...
fn benchmark_sync_cycle(sender: &HiveMesh, receiver: &HiveMesh, iterations: usize) -> Duration {
...
fn benchmark_encryption_latency() {
    println!("\n");
    println!("{}", "=".repeat(180));
    println!("HIVE-BTLE Encryption Benchmark: Sync Latency Comparison");
    println!("{}", "=".repeat(180));
    ...
    for (chat_count, label) in DOCUMENT_SIZES {
        ...
        populate_mesh_with_chats(&sender_plain, *chat_count);
        populate_mesh_with_chats(&sender_enc, *chat_count);
...
fn benchmark_encryption_throughput() {
    println!("\n");
    println!("{}", "=".repeat(100));
    println!("HIVE-BTLE Encryption Throughput Benchmark");
    println!("{}", "=".repeat(100));
