...
impl HiveObserver for PrintObserver {
...
fn main() {
    println!("=== HIVE-BTLE Basic Mesh Example ===\n");

    // Create two mesh nodes
    let config_alpha = HiveMeshConfig::new(NodeId::new(0x11111111), "ALPHA-1", "DEMO");
    let config_bravo = HiveMeshConfig::new(NodeId::new(0x22222222), "BRAVO-1", "DEMO");
