# Pure-Rust Architecture for hive-btle on nRF52840

> Reference document for Codex and contributors working on the embedded Rust
> implementation of hive-btle targeting Nordic nRF52840 hardware.

## Why Pure Rust

The CircuitPython and SoftDevice paths on nRF52840 are dead ends for HIVE:
...
HIVE minimum encryption requirement: AES-128-CCM or ChaCha20-Poly1305.
...
The nRF52840 is a strong foundation for a custom HIVE board with a trusted supply chain.
...
1. **Board A** advertises a HIVE beacon with a payload
...
6. HIVE mesh protocol framing on top
...
This is a reference implementation / example within hive-btle, not a separate project.
...
hive-btle is a **protocol spec with reference implementations**, not a single codebase:
...
hardware crypto, memory safety, NDAA-compliant silicon. This is what ships on custom HIVE
