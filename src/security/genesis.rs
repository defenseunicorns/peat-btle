...
//! Mesh genesis protocol for creating new HIVE meshes
//!
...
//!
//! ```
//! use hive_btle::security::{DeviceIdentity, MeshGenesis, MembershipPolicy};
//!
...
impl MeshGenesis {
    ...
    const ENCRYPTION_CONTEXT: &'static [u8] = b"HIVE-mesh-encryption-v1";

    /// HKDF context for beacon key derivation
    const BEACON_CONTEXT: &'static [u8] = b"HIVE-beacon-key-v1";
