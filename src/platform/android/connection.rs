...
//! are managed by the Kotlin HiveBtle class using Android BluetoothGatt APIs.
//!
//! On Android, connection lifecycle is:
//! 1. Kotlin HiveBtle discovers devices via BluetoothLeScanner
//! 2. Kotlin connects via BluetoothDevice.connectGatt()
//! 3. Kotlin calls HiveMesh.onBleConnected() via UniFFI
//! 4. Kotlin reads/writes GATT characteristics
//! 5. Kotlin calls HiveMesh.onBleDataReceived() via UniFFI
//! 6. On disconnect, Kotlin calls HiveMesh.onBleDisconnected() via UniFFI
